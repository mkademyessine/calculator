class Application(object):
    def __init__(self):
       ...
       self.root =Tk()
       self.root.title('Colours Code ')
       self.dessineResistance()
       Label(self.root, text ="Enter the resistance value in Ohms :").grid(row =2, column =1, columnspan =3)
       Button(self.root, text ='Show', command =self.changeCouleurs,width=10).grid(row =3, column =1)
       Button(self.root, text ='Exit', command =self.root.quit,width=10).grid(row =3, column =3)
